...
<h1 style="text-align: center">Bon de Entree</h1>
   ...
   <table class="table table-borderd" >
       ...
       <tbody>
    <td >
       <select class="form-control"  name="b_sortie_id" id="b_sortie_id"> 
           <option value="" > --- Select Bon de Sortie --- </option>
    ...
    <td >
         <select class="form-control"  name="magasin_id" id="magasin_id"> 
           <option value="" > --- Select un magasin --- </option>
...
<div class="row">
   ...
   <table class="table table-striped table-bordred">
          <thead>
           ...
           <th style="width: 22%">Quantite</th>
           <th style="width: 22%">Prix</th>
           <th style="width: 22%">Garantie</th>
...
function newstore()
{
        ...
        $token = "{{ csrf_token() }}" ;
        formData.append('b_sortie_id', $('#b_sortie_id').val());
        formData.append('magasin_id', $('#magasin_id').val());
